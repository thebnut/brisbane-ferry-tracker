...
const MobileBoardHeader = ({ 
  ...
  return (
    <div className="flex items-center space-x-2 mb-6 rounded-xl overflow-hidden border-2 border-ferry-orange/30 shadow-lg bg-white/90 backdrop-blur-sm p-2">
      <StopDropdown
        value={originStop.id}
      ...
      <button
        ...
        className="p-2 text-ferry-orange hover:bg-ferry-orange-light rounded-lg transition-all active:scale-95"
